...
class TenantIsolationTest extends TestCase
{
    ...
    public function test_center_user_cannot_bypass_scope_via_api_guard()
    {
        $this->seed();
        ...
        $center1->director_name = 'Dir 1';
        $center1->mobile = '01234567891';
        $center1->email = 'c1_api@example.com';
        $center1->status = 1;
        $center1->save();
        ...
        $center2->director_name = 'Dir 2';
        $center2->mobile = '01234567892';
        $center2->email = 'c2_api@example.com';
        $center2->status = 1;
        $center2->save();

        $user1 = new User;
        $user1->name = 'Center User 1';
        $user1->username = 'center1_api';
        $user1->phone = '01234567891';
        $user1->email = 'c1_api_user@example.com';
        $user1->password = Hash::make('password');
        $user1->center_id = $center1->id;
        $user1->save();
        ...
        $studentsCount = Student::count();
        $this->assertEquals(1, $studentsCount, 'CenterScope should isolate the student count to 1 even on API guard');
    }
}
