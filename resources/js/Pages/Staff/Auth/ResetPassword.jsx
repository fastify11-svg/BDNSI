...
export default function ResetPassword({ token, email }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(getUrl('/staff/reset-password'));
    };
    ...
    return (
        <div className="min-h-screen bg-[#070F1E] flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans selection:bg-purple-500 selection:text-white">
            <Head title="Set New Staff Password" />
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md text-center px-4">
                ...
                <p className="mt-2 text-xs text-slate-400 font-medium">
                    Choose a strong password to secure your staff portal account.
                </p>
            </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 bg-[#081224] border border-slate-700/80 rounded-xl text-sm text-white focus:outline-none focus:ring-2 focus:ring-purple-500/30 focus:border-purple-500 transition"
                            />
