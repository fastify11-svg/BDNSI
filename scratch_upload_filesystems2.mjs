...
async function run() {
    await uploadFile('C:\\BDNSI\\config\\filesystems.php', 'public/scratch_filesystems.php');
    await uploadFile('C:\\BDNSI\\scratch_move_filesystems.php', 'public/scratch_move_filesystems.php');
    await uploadFile('C:\\BDNSI\\scratch_clear_config.php', 'public/scratch_clear_config.php');
}
